...
class PaymentBloc extends Bloc<PaymentEvent, PaymentState> {
  ...
  Future<Map<String, dynamic>> _callPayEndpointIntent({
    ...
    final url = Uri.parse(
        'https://us-central1-tutorme-25663.cloudfunctions.net/StripePayEndpointIntentId');
  ...
  Future<Map<String, dynamic>> _callPayEndpointMethodId({
    ...
    final url = Uri.parse(
        'https://us-central1-tutorme-25663.cloudfunctions.net/StripePayEndpointMethodId');
